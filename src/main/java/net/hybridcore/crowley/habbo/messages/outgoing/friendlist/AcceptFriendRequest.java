//package net.hybridcore.crowley.habbo.messages.outgoing_old.messenger;
//
...
//
//        // Update friendlist
//        Crowley.getExecutorService().execute(new FriendListUpdateComposer(this.gameSession, null));
//
//        // Same for your new friend
//        GameSession friendSession = Crowley.getHabbo().getSessions().getSession(friend);
//
//        if (friendSession != null) {
//            Crowley.getExecutorService().execute(new FriendListUpdateComposer(friendSession, null));
//        }
//    }
//}
