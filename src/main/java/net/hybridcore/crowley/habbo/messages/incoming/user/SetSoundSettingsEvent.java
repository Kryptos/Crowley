...
import net.hybridcore.crowley.habbo.messages.outgoing_old.user.UpdateSoundPreference;
 ...
 */
public class SetSoundSettingsEvent implements IncomingMessage {

    public void handle(GameSession gameSession, ClientMessage message) {
        Crowley.getExecutorService().execute(new UpdateSoundPreference(gameSession, message.readInt()));
    }
}
